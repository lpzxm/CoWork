...
const StatusIcon = ({ status }) => {
    switch (status) {
        case 'info':
            return (
                <Avatar
                    className="text-blue-600 bg-blue-100 dark:bg-blue-500/20 dark:text-blue-100"
                    shape="circle"
                >
...
const ConfirmDialog = (props) => {
    ...
    return (
        ...
        >
            ...
            <div className="px-6 py-3 text-right bg-gray-100 rounded-bl-lg rounded-br-lg dark:bg-gray-700">
                <Button
                    disabled={loading}
                    size="sm"
