...
<head>
    ...
    <title>Nueva tarea asignada - CoWork</title>
</head>
                        ...
                        <td style="padding:0 0 24px 0;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td align="right" style="font-size:13px;color:#64748b;">Nueva asignación</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-bottom:20px;">
                                        ...
                                        <p style="margin:0;font-size:15px;color:#475569;line-height:1.5;">Te han asignado una nueva tarea en CoWork.</p>
                                    </td>
                                </tr>
                                <tr>
